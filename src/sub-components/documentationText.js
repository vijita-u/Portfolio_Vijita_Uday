...
export const amazonDoc = {
	...
	reason: "I dove into this project right after getting the hang of ReactJs, eager to dig deeper into the framework and explore Firebase, Firebase Cloud Functions, Stripe, Material UI, React-Context-API, axios and more.  Crafting the entire spectrum of features, from user authentication to payment functionality, really helped me hone my skills a lot more. Special thanks to Clever Programmer for the inspiration from their Amazon Clone project.",
	additionalFeatures:
...
export const linkedinDoc = {
	...
	reason: "I jumped into this project right after working on the Amazon Clone. It was a way to dig deeper into React and Firebase, especially when it came to cool stuff like user authentication and Firestore. Additionally, I sought to explore Redux for state management, opting for it over React's context API.",
	additionalFeatures:
...
export const magmaDoc = {
	...
	reason: "The website's stunning visuals motivated me to learn the art of creating intricate animations. To achieve this, I delved into HTML5 Canvas and GSAP, essential tools for crafting engaging animations. My goal was to enhance my web development skills and unleash my creative potential.",
	additionalFeatures:
...
export const thisisdigitalDoc = {
	...
	reason: "The core objective behind this project was to gain firsthand experience in utilizing GSAP timelines, Scroll Trigger, and Swiper JS for the very first time.",
	additionalFeatures:
...
export const codingcontestDoc = {
	...
	reason: "My motivation for embarking on this project was to gain hands-on experience with Fetch API and delve into the world of JavaScript promises.",
	additionalFeatures:
...
export const tictactoeDoc = {
	...
	reason: "I chose to embark on this project as a means of acquiring knowledge in React. It was an invaluable project tutorial sourced from the official React documentation, marking an excellent commencement of my journey into the world of React development.",
	additionalFeatures:
...
export const portfolioDoc = {
	...
	reason: "I crafted my portfolio with ReactJS to deepen my practical experience in both React and web development. While initially exploring animations with GSAP, I encountered compatibility challenges within the React environment. It was then that I discovered Framer Motion, a React-specific animation library. Eager to expand my skills, I swiftly immersed myself in mastering Framer Motion, making this portfolio my first venture with the library.",
	additionalFeatures:
