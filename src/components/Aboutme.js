        ...
        <div className="AMcontent__body main">
          ...
          <Reveal>
            <div className="AMcontent__info">
              <p>
                Hi there! I’m a frontend React developer with a flair for
                turning ideas into web magic. From crunching numbers in finance
                to crafting stunning web experiences, I blend creativity with
                precision. Whether it’s React, HTML, CSS, JavaScript, Webflow,
                or WordPress, I’ve got the tools to bring your vision to life.
              </p>
              <p>
                If you're looking for someone who can make your website or web
                app not just functional but fabulous, let's team up and create
